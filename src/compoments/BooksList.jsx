...
console.log(arr);
  ...
  return <div className="book-card">
       ...
       <div className="links">
       <Link className="link-single" to='/'>الرئيسية</Link>
       <Link className="link-single" to="/book-info">المفضلة</Link>
       </div>
...
function SingleBook (props){
    ...
    <div className="btn-style">
      <button className="btn2" type="button" onClick={()=>props.onAdd(props.id)}>اضافة للمفضلة</button>
      <button type="button" onClick={props.onInfo} className="btn2">عرض المفضلة</button>
    </div>
 </div>
}
...
SingleBook.defaultProps = {
  bookDis : "Lorem ipsum dolor sit amet. Vel modi blanditiis non molestiae similique laborum quo voluptatem numquam est omnis accusamus. Non quia impedit qui sunt praesentium et rerum delectus vel minus galisum quo quidem voluptas.",
