...
function App() {
  ...
  useEffect(() => {
    if (localStorage.getItem("book") !== null) saveBooks();
  }, []);
  ...
  return (
    <HashRouter>
      <Routes>
        <Route
          element={<Main saveBooks={saveBooks} bookData={bookData} />}
          path="/"
        />
        <Route
          element={<ViewBooks bookData={bookData} setBookData={setBookData} />}
          path="book-info"
        />
