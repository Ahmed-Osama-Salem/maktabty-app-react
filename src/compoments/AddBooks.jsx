...
console.log(booksData);
 return <div className="add-books">
    ...
    <form onSubmit={handelSubmit}>
        ...
        <button className="btn2" type="submit">اضافة كتاب</button>
    </form>
    <Link className="btn2" to="/">القائمة الرئيسية</Link>
    <div className="flex-books">
   {bookAdd.map((newBook)=>{
     return <div className="book-new">
        <img alt="book" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpbJuy6d3MzgFt_8fyEV2FlhtQX6Ej542D5Wseoa3NSH5BGMJxHf-JnWz9nSRpgqMfTgg&usqp=CAU"/>
